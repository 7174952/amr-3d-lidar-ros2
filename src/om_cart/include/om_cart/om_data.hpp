/**
* @file    om_data.h
* @brief   Make and send motor command to driver (ROS2 version)
* @details
* @attention
* @note
...
public:
    Om_data();
    int8_t set_share_ID(uint8_t slave_id, uint8_t sub_id, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub);
    int8_t set_share_net_id(uint8_t slave_id, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub);
    int8_t reset_alarm(uint8_t slave_id, int8_t val, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub);
    int8_t update_share_state(uint8_t slave_share_id, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub);
    int8_t drive_wheel_begin(uint8_t slave_id, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub);
    int8_t drive_wheel_end(uint8_t slave_id, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub);
    int8_t drive_wheel_cmd(uint8_t slave_id, int32_t vel_l, int32_t vel_r, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub);
    int8_t drive_cart_cmd(uint8_t slave_id, int32_t cart_vel_line, double cart_vel_theta, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub);
    int8_t get_lastest_query(om_msgs::msg::Query *query_msg);
...
public:
    ...
    const uint8_t f_read = 0;        // read multiple bytes from motor
    const uint8_t f_write = 1;       // write multiple bytes to motor
...
int8_t Om_data::set_share_ID(uint8_t slave_id, uint8_t sub_id, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub)
{
    // 1軸の設定
    clear_buff();
...
int8_t Om_data::set_share_net_id(uint8_t slave_id, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub)
{
    // 1軸の設定
    clear_buff();
    msg.slave_id = slave_id;     // 書き込むドライバのスレーブID
...
int8_t Om_data::reset_alarm(uint8_t slave_id, int8_t val, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub)
{
    clear_buff();
...
int8_t Om_data::update_share_state(uint8_t slave_share_id, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub)
{
    clear_buff();
...
int8_t Om_data::drive_wheel_end(uint8_t slave_id, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub)
{
    // 運転指令(S-ONをOFFする)
    clear_buff();
    msg.slave_id = slave_id;      // スレーブID
...
int8_t Om_data::drive_wheel_cmd(uint8_t slave_id, int32_t vel_l, int32_t vel_r, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub)
{
    clear_buff();
...
int8_t Om_data::drive_cart_cmd(uint8_t slave_id, int32_t cart_vel_line, double cart_vel_theta, rclcpp::Publisher<om_msgs::msg::Query>::SharedPtr pub)
{
